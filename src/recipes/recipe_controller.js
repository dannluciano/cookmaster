...
module.exports = {
	createRecipe: async (req, res) => {
		try {
			const { name = null, ingredients = null, preparation = null } = req.body;
			const { id: userId = null } = req.currentUser;
	...
	addImageToRecipe: (req, res) => {
		try {
			req.recipe.image =
				UPLOAD_PATH.replace("/src/uploads/", "/images/") + req.file.filename;
			req.recipe.save();
